...
namespace TypeReferences {
	...
	/// </summary>
	[AttributeUsage(AttributeTargets.Field, AllowMultiple = false)]
	public sealed class ClassOfEnumAttribute : ClassTypeConstraintAttribute
	{

		/// <summary>
		/// Initializes a new instance of the <see cref="ClassOfEnumAttribute"/> class.
		/// </summary>
		public ClassOfEnumAttribute()
		{
			//AllowAbstract = true;
		}
		...
		{
			return base.IsConstraintSatisfied(type)
				&& type.IsSubclassOf(typeof(System.Enum));
		}
